      ...
      {filePath && (
        <Button
          ...
          onClick={() => {
            ...
            link.href = `http://localhost:8080/report/downloadReport?filePath=${filePath}`;
          ...
          <TableBody>
            {currentPageData.map((pessoa) => (
              <TableRow key={pessoa.id}>
                ...
                <TableCell>
                  {[pessoa.address, pessoa.number, pessoa.complements, pessoa.district, pessoa.city, pessoa.state]
